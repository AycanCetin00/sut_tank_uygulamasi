...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    final url = Uri.parse('http://192.168.142.211:5266/api/Kullanici');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Detaylı hata mesajı
        setState(() {
          _errorMessage = 'Giriş başarısız: ${response.body}';
        });
      }
    } catch (e) {
      setState(() {
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    final url = Uri.parse('http://10.56.8.249:5266/api/kullanici/login');
